%abalone_test.m
%Author: Adam Swart
%Tests a neural network trained in abalone_train.m
...
%simulate
atrain=sim(abalonenet,ptrain); %train
atest = sim(abalonenet,ptest); %test
a = sim(abalonenet,p);         %all
